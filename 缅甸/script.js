	...
	series: [
		{
			...
			barWidth: 20,
			data: [
				260, 390, 390, 264, 287, 307, 375.6, 482.2, 387, 388, 300, 230
			],
			itemStyle: {
				color: '#1494D4'
			}
	...
	series: [
		{
			...
			data: [
				...
				{
					value: 735, name: '陆军', itemStyle: {
						color: "#1893CC"
					}
				},
				{
					value: 580, name: '空军', itemStyle: {
						color: "#FFB264 "
					}
				},
			]
...
function roll(t,id,cid,fid) {
	...
	var timer = setInterval(() => { rollStart(id, cid, timer, fid); }, t);
